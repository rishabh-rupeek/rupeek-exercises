...
// 2. Write a MongoDB query to display the fields restaurant_id, name, borough and cuisine for all the documents in the collection restaurant. Go to the editor
db.restaurants.find({},{
    restaurant_id:1, 
    name:1, 
    borough:1, 
